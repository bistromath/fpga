...
/*
  noc_block_gain inst0_noc_block_gain (
     .bus_clk(bus_clk), .bus_rst(bus_rst),
     .ce_clk(ce_clk), .ce_rst(ce_rst),
  ...
  noc_block_gain #(
     .NOC_ID(64'hB00C_0000_0000_0000))
   inst1_noc_block_gain (
     .bus_clk(bus_clk), .bus_rst(bus_rst),
     .ce_clk(ce_clk), .ce_rst(ce_rst),
     .i_tdata(ce_o_tdata[2]), .i_tlast(ce_o_tlast[2]), .i_tvalid(ce_o_tvalid[2]), .i_tready(ce_o_tready[2]),
     .o_tdata(ce_i_tdata[2]), .o_tlast(ce_i_tlast[2]), .o_tvalid(ce_i_tvalid[2]), .o_tready(ce_i_tready[3]),
     .debug(ce_debug[2]));
*/
  ...
  noc_block_predistort #(
     .NUM_CHANNELS(4))
     inst_noc_block_predistort (
     .bus_clk(bus_clk), .bus_rst(bus_rst),
     .ce_clk(ce_clk), .ce_rst(ce_rst),
